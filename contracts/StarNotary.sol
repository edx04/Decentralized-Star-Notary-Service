...
contract StarNotary is ERC721 {
    ...
    constructor() ERC721("Cat Token", "CAT") {}
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require((ownerOne == msg.sender || ownerTwo == msg.sender), "You don't ownany of the tokens");
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        require(owner == msg.sender, "You are not the owner of the  start");
